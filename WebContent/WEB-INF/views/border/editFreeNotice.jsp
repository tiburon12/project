	...
	<div id="container">
		...
		<div id="body" class="width"
			...
			<fieldset>
				...
				<form action="editFreeNoticeProc.jsp" method="post"
					style="font-size: 20px">
					<p>
						<label for="title">제목:</label> <input name="title" id="title"
							value="<%=fb.getTitle()%>" type="text" style="width: 80%" />
					</p>
					<p>
						<label for="content">글내용:</label>
						<textarea rows="20" name="content" id="content" style="width: 80%"><%=fb.getContent()%></textarea>
					</p>
					<p>
						<input type="hidden" name="border" value="<%=border%>" /> <input
							type="hidden" name="pages" value="<%=pages%>" /> <input
							type="hidden" name="seq" value="<%=fb.getSeq()%>" /> <input
