...
<body>
	<div id="container">
		...
		<div id="body" class="width"
			...
			<h1 style="margin: 20px; font-size: 70px">SELL</h1>
			<table cellspacing="0">
				<tr>
				...
				<c:forEach var="i" items="${list}">
					<tr>
						...
						<td>${i.pick}</td>
						<td><a
							href="detail.do?border=sell&pages=${pages}&seq=${i.seq}"
			...
			<div style="margin-top: 20px">
				<p style="float: left; margin-left: 40%; width: 45px">
					<c:if test="${startPageNum != 1}">
						...
						<a href="sellBorder.do?pages=${startPageNum - 1}"><img
						...
						<c:if test="${startPageNum + i <= endPageNum}">
							<c:if test="${(startPageNum + i) == pages}">
								<a style="color: #ff0000; font-size: 25px; font-weight: bold;"
									href="sellBorder.do?pages=${startPageNum + i}">${startPageNum + i}</a>
							</c:if>
							<c:if test="${(startPageNum + i) != pages}">
				...
				<p style="float: left; width: 45px">
					...
					<c:if test="${startPageNum +4 < endPageNum}">
						<a href="sellBorder.do?pages=${startPageNum + 5}"><img
